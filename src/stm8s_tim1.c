/**
  ...
  ******************************************************************************
  */
#ifndef __STM8S_TIM1_C
#define __STM8S_TIM1_C
...
#if defined(TIM1_TI3_Config)|| defined(TIM1_ICInit_DEF)
static void TIM1_TI3_Config(uint8_t TIM1_ICPolarity, uint8_t TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
#endif
