...
/**
  * @brief  Selects the TIM2Тs One Pulse Mode.
...
/**
  * @brief  Clears the TIM2Тs pending flags.
...
void TIM2_ClearFlag(TIM2_FLAG_TypeDef TIM2_FLAG)
{
  ...
  /* Clear the flags (rc_w0) clear this bit by writing 0. Writing С1Т has no effect*/
...
#if defined(TIM2_ICInit_DEF)||defined(TIM2_PWMIConfig_DEF)
/**
